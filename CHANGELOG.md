...
- **CLI fixture test expected stripped names** — `test-cli-fixture.sh` now matches clean `full_name` values after v0.9.1 started stripping `__FOCUS__` prefixes from JSON output
...
[Unreleased]: https://github.com/stateruntime/behave/compare/v0.9.2...HEAD
[0.9.2]: https://github.com/stateruntime/behave/compare/v0.9.1...v0.9.2
[0.9.1]: https://github.com/stateruntime/behave/compare/v0.9.0...v0.9.1
